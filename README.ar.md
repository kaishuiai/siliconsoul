...
> حالة التحديث (2026-04-08): في PRD Phase 0 (الدفعة الثالثة) تم توحيد الحقول القياسية بين process/batch/replay (مع الحفاظ على التوافق) وتحسين ملخص المقارنة في History.
