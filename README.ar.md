...
> حالة التحديث (2026-04-08): في PRD Phase 1 (الدفعة الخامسة) تمت إضافة تقييم مخاطر السلسلة وفرز متعدد الأبعاد (latest/risk/depth/activity) لتحسين ترتيب أولويات المراجعة.
