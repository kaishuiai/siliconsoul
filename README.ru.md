...
> Статус обновления (2026-04-08): PRD Phase 1 (пакет 4) добавляет рабочую панель корневых запросов и навигацию по Top-узлам изменений для ревью на уровне цепочек.
