...
> Статус обновления (2026-04-08): PRD Phase 0 (пакет 3) унифицировал стандартизированные поля для process/batch/replay (с совместимостью) и улучшил сводку сравнения в History.
