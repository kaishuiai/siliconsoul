...
> Статус обновления (2026-04-08): PRD Phase 0 (пакет 2) выровнял контракт деталей History (добавлены совместимые поля `expert_results`/`result`) и продолжает выравнивание цепочки replay.
