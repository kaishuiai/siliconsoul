...
> Statut de mise à jour (2026-04-08) : PRD Phase 1 (lot 8) ajoute des operation receipts pour quick-actions (statut/new request ID/durée), avec filtrage et export JSON/MD.
